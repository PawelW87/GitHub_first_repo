...
print("Dzień dobry Traderze. Szukasz kursu waluty w dniu poprzedzającym twoje ruchy?")
###  POBIERANIE DANYCH OD UŻYTKOWNIKA
date_ask = "Wprowadź datę transakcji(YYYY-MM-DD):"
...
new_date -= timedelta(days=1)  #### Program ma szukać kursu w dniu poprzedzającym transakcję giełdową
